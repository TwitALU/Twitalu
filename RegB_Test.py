...
while True:
	delayTime = 1
	RegB.write_register(0b00000001)
	time.sleep(delayTime)
	RegB.write_register(0b00000010)
	time.sleep(delayTime)
	RegB.write_register(0b00000100)
	time.sleep(delayTime)
	RegB.write_register(0b00001000)
	time.sleep(delayTime)
	RegB.write_register(0b00010000)
	time.sleep(delayTime)
	RegB.write_register(0b00100000)
	time.sleep(delayTime)
	RegB.write_register(0b01000000)
	time.sleep(delayTime)
	RegB.write_register(0b10000000)
	time.sleep(delayTime)